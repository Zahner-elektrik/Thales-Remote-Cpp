...
typedef bool (__stdcall  *setupPAD4Type)(void* handle, char* retval, int* retvalLen , int card, int channel, bool enabled);
typedef bool (__stdcall  *enablePAD4Type)(void* handle, char* retval, int* retvalLen , bool enabled);
typedef bool (__stdcall  *disablePAD4Type)(void* handle, char* retval, int* retvalLen );
...
//    lib = LoadLibrary(TEXT("libThalesRemoteExternalLibrary.dll"));
    ...
    else
    {
        ...
        setupPAD4Type setupPAD4 = (setupPAD4Type) GetProcAddress(lib, "setupPAD4");
        enablePAD4Type enablePAD4 = (enablePAD4Type) GetProcAddress(lib, "enablePAD4");
        disablePAD4Type disablePAD4 = (disablePAD4Type) GetProcAddress(lib, "disablePAD4");
        ...
        replySize = 1000;
        enableSaveReceivedFilesToDisk(fileInterfaceHandler, R"(C:\THALES\temp\exchange)",true);
